...
enum gossipTexts
{
	GOSSIP_ITEM_JAIN_START = -3534000,
	JAINA_GOSSIP_ITEM_ANATHERON = -3534001,
	JAINA_GOSSIP_ITEM_SUCCESS = -3534002,
	GOSSIP_ITEM_THRALL_START = -3534003,
	THRALL_GOSSIP_ITEM_AZGALOR = -3534004,
	THRALL_GOSSIP_ITEM_SUCCESS = -3534005,
	TYRANDE_GOSSIP_ITEM_AID = -3534006
};
